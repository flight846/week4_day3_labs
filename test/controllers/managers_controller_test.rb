...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: { cellphone_number: @manager.cellphone_number, email: @manager.email, name: @manager.name, office_number: @manager.office_number } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { cellphone_number: @manager.cellphone_number, email: @manager.email, name: @manager.name, office_number: @manager.office_number } }
