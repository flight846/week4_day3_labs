...
class ArtistSongsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artist_song" do
    assert_difference('ArtistSong.count') do
      post artist_songs_url, params: { artist_song: { artist_id: @artist_song.artist_id, song_id: @artist_song.song_id } }
    end
  ...
  test "should update artist_song" do
    patch artist_song_url(@artist_song), params: { artist_song: { artist_id: @artist_song.artist_id, song_id: @artist_song.song_id } }
